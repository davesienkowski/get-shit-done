...
<required_reading>
@D:/Repos/get-shit-done/.cursor/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Repos/get-shit-done/.cursor
                  → checks D:/Repos/get-shit-done/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Repos/get-shit-done/.cursor/get-shit-done
                  → writes to D:/Repos/get-shit-done/.cursor/get-shit-done/hooks/
...
@D:/Repos/get-shit-done/.cursor/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Repos/get-shit-done/.cursor/get-shit-done/references/common-bug-patterns.md
