...
@D:/Repos/get-shit-done/.cursor/get-shit-done/references/thinking-models-planning.md
...
```bash
gsd-sdk query commit "docs($PHASE): create phase plan" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md .planning/ROADMAP.md
```
</step>
