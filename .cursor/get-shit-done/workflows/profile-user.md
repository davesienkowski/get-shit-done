...
Key references:
- @D:/Repos/get-shit-done/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @D:/Repos/get-shit-done/.cursor/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Repos/get-shit-done/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Repos/get-shit-done/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/Repos/get-shit-done/.cursor/get-shit-done/USER-PROFILE.md" "D:/Repos/get-shit-done/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Repos/get-shit-done/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Repos/get-shit-done/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @D:/Repos/get-shit-done/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/Repos/get-shit-done/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to D:/Repos/get-shit-done/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Repos/get-shit-done/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/Repos/get-shit-done/.cursor/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/Repos/get-shit-done/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="D:/Repos/get-shit-done/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Repos/get-shit-done/.cursor/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/Repos/get-shit-done/.cursor/commands/gsd/dev-preferences.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        D:/Repos/get-shit-done/.cursor/.cursor/rules/
```
