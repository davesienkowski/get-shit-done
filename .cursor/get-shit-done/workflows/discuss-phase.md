...
<required_reading>
@D:/Repos/get-shit-done/.cursor/get-shit-done/references/domain-probes.md
@D:/Repos/get-shit-done/.cursor/get-shit-done/references/gate-prompts.md
@D:/Repos/get-shit-done/.cursor/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @D:/Repos/get-shit-done/.cursor/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @D:/Repos/get-shit-done/.cursor/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @D:/Repos/get-shit-done/.cursor/get-shit-done/workflows/discuss-phase-power.md
