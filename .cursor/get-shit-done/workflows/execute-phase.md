...
@D:/Repos/get-shit-done/.cursor/get-shit-done/references/agent-contracts.md
@D:/Repos/get-shit-done/.cursor/get-shit-done/references/context-budget.md
@D:/Repos/get-shit-done/.cursor/get-shit-done/references/gates.md
</required_reading>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `D:/Repos/get-shit-done/.cursor/get-shit-done/workflows/execute-plan.md` **inline**
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Task(
     ...
     prompt="
       ...
       @D:/Repos/get-shit-done/.cursor/get-shit-done/templates/summary.md
       @D:/Repos/get-shit-done/.cursor/get-shit-done/references/checkpoints.md
       @D:/Repos/get-shit-done/.cursor/get-shit-done/references/tdd.md
       </execution_context>
...
5.6. **Post-wave shared artifact update (worktree mode only):**
   ...
   for PLAN_ID in ${WAVE_PLAN_IDS}; do
     gsd-sdk query roadmap.update-plan-progress "${PHASE_NUMBER}" "${PLAN_ID}" completed
   done
...
Read and follow `D:/Repos/get-shit-done/.cursor/get-shit-done/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
