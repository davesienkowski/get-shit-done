...
```markdown
Read D:/Repos/get-shit-done/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Repos/get-shit-done/.cursor/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Repos/get-shit-done/.cursor/agents/gsd-ui-checker.md for instructions.
