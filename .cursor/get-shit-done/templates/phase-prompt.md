...
<!-- For checkpoint task examples and patterns, see @D:/Repos/get-shit-done/.cursor/get-shit-done/references/checkpoints.md -->
...
See `D:/Repos/get-shit-done/.cursor/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Repos/get-shit-done/.cursor/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Repos/get-shit-done/.cursor/get-shit-done/workflows/verify-phase.md` for verification logic.
